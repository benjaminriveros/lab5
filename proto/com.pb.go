...
type Vector struct {
	...
	Sv1 int32 `protobuf:"varint,1,opt,name=Sv1,proto3" json:"Sv1,omitempty"`
	Sv2 int32 `protobuf:"varint,2,opt,name=Sv2,proto3" json:"Sv2,omitempty"`
	Sv3 int32 `protobuf:"varint,3,opt,name=Sv3,proto3" json:"Sv3,omitempty"`
}

func (x *Vector) Reset() {
	*x = Vector{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_com_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Vector) Descriptor() ([]byte, []int) {
	return file_proto_com_proto_rawDescGZIP(), []int{2}
}

func (x *Vector) GetSv1() int32 {
	if x != nil {
		return x.Sv1
	}
	return 0
...
var file_proto_com_proto_rawDesc = []byte{
	...
	0x69, 0x70, 0x22, 0x3e, 0x0a, 0x06, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x10, 0x0a, 0x03,
	0x53, 0x76, 0x31, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x53, 0x76, 0x31, 0x12, 0x10,
	0x0a, 0x03, 0x53, 0x76, 0x32, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x53, 0x76, 0x32,
	0x12, 0x10, 0x0a, 0x03, 0x53, 0x76, 0x33, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x53,
	0x76, 0x33, 0x32, 0x65, 0x0a, 0x07, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x6c, 0x12, 0x28, 0x0a,
	...
	0x64, 0x65, 0x2e, 0x49, 0x70, 0x22, 0x00, 0x12, 0x30, 0x0a, 0x0f, 0x72, 0x65, 0x67, 0x69, 0x73,
	0x74, 0x65, 0x72, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x12, 0x0d, 0x2e, 0x63, 0x6f, 0x64,
	0x65, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x1a, 0x0c, 0x2e, 0x63, 0x6f, 0x64, 0x65,
	0x2e, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x22, 0x00, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x70,
...
var file_proto_com_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_com_proto_goTypes = []interface{}{
	(*Command)(nil), // 0: code.Command
	(*Ip)(nil),      // 1: code.Ip
	(*Vector)(nil),  // 2: code.Vector
}
var file_proto_com_proto_depIdxs = []int32{
	0, // 0: code.General.sendCommand:input_type -> code.Command
	0, // 1: code.General.registerCommand:input_type -> code.Command
	1, // 2: code.General.sendCommand:output_type -> code.Ip
	2, // 3: code.General.registerCommand:output_type -> code.Vector
...
func file_proto_com_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_com_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Vector); i {
			case 0:
				return &v.state
			case 1:
